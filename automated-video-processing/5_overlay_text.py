...
intro_duration = 5
intro_text = TextClip("Hello world!", fontsize=70,
                      color='white', size=video_clip.size)
...
watermark_size = 60
watermark_text = TextClip("CFE", fontsize=watermark_size,
                          color='white', align='West', size=(w, watermark_size))
...
overlay_clip = CompositeVideoClip(
    [video_clip, watermark_text], size=video_clip.size)
